...
//        [self directFlag:ctx rect:rect];
        ...
        [self circleNormalNotSelected:ctx rect:rect];
    }
...
-(void)circleNormalNotSelected:(CGContextRef)ctx rect:(CGRect)rect{
...
/*
        CGFloat sizeWH = (self.bounds.size.width - lineW) * 0.3;
//        CGFloat originXY = lineW *.5f;
        CGFloat originXY = (self.bounds.size.width - sizeWH) / 2;
...
//        CGFloat selectRectWH = rect.size.width * 1.2;
//        
////        CGFloat selectRectXY = rect.size.width * (1 - CoreLockArcWHR) *.5f;
//                CGFloat selectRectXY = rect.size.width * (1 - 1.2) *.5f;
//        
//        _selectedRect = CGRectMake(selectRectXY, selectRectXY, selectRectWH, selectRectWH);

        if (iphone5x_4_0) {
            CGFloat selectRectWH = rect.size.width-1;
            CGFloat selectRectXY = 0.5;
            _selectedRect = CGRectMake(selectRectXY, selectRectXY, selectRectWH, selectRectWH);
