...
@implementation renmaitouzitable
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    static NSString *indentifier = @"Best_User_Cell117";
    renmaitouziTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:indentifier];
    
    cell = [[[NSBundle mainBundle]loadNibNamed:@"renmaitouziTableViewCell"
                                         owner:self
    ...
    if (cell==nil) {
        ...
        cell = [[renmaitouziTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:indentifier];
    }
    if (indexPath.row<self.data.count) {
        renmaitouzimodel *model = self.data[indexPath.row];
