...
#import "UICommons.h"
#import "Masonry.h"
@interface RiskGuaranteeViewController ()
{
...
@implementation RiskGuaranteeViewController
...
- (void)requestWebViewURL{
    ...
    NSString *urlStr = @"http://debug.otouzi.com:8012/SiteNotice/riskReserveFund.html";
 ...
 navigationType:(UIWebViewNavigationType)navigationType {
    ...
    if (range.length!=0) {
        ...
        if ([array[0] isEqualToString:@"app.d"]) {
            ...
            NSLog(@"风险保障金%@", decodedString); //Base64转字符串 NSSTRING
