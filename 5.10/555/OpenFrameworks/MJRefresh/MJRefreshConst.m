...
NSString *const MJRefreshAutoFooterIdleText = @"点击加载更多";//点击或上拉加载更多
NSString *const MJRefreshAutoFooterRefreshingText = @"正在加载更多的数据...";
NSString *const MJRefreshAutoFooterNoMoreDataText = @"已经全部加载";//已经全部加载完毕
...
NSString *const MJRefreshBackFooterNoMoreDataText = @"已经全部加载...";