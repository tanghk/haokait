//
//  ExchangeConponViewController.m
//  555
//
...
#import "UICommons.h"
#import "Masonry.h"
#import "ExchangeSucuessViewController.h"
#import "UIViewExt.h"
#import "DataService.h"
@interface ExchangeConponViewController (){
...
@implementation ExchangeConponViewController
...
- (void)loadExchangeCode:(id)result{
    ...
    if ([codeNumber isEqualToNumber:@200]) {
        ...
        ExchangeSucuessViewController *exchangeVC =[[ExchangeSucuessViewController alloc]init];
        exchangeVC.codeDic = dataDic;
