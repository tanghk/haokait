 ...
 *  外环线条颜色：默认
 */
#define CoreLockCircleLineNormalColor rgba(255,255,255,1)//241241241


/*
 *  外环线条颜色：选中
 */
#define CoreLockCircleLineSelectedColor rgba(255,255,255,1)//(34,178,246,1)


/*
 *  实心圆
 */
#define CoreLockCircleLineSelectedCircleColor rgba(255,255,255,1)//rgba(34,178,246,1)


/*
 *  实心圆
 */
#define CoreLockLockLineColor rgba(255,255,255,1)//rgba(34,178,246,1)
 ...
 *  警示文字颜色
 */
#define CoreLockWarnColor rgba(255,238,93,1)
...
/** 修改密码：普通提示文字 */
extern NSString *const CoreLockNew;
