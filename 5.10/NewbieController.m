...
@implementation NewbieController
...
- (void)custumNewbie{
    ...
    scrol.frame = CGRectMake(0, 64.5, kScreenWidth, kScreenHeight-64.5);
    ...
    if ([code intValue]==200) {
        ...
        if ([isOpen intValue] ==0 ) {
            ...
            if ([isOpen intValue] ==1 &&[money intValue]>=1 ) {
                ...
                NewBieInvestController *newBieInvest = [[NewBieInvestController alloc]init];
     ...
     HadInvestController *hasUsed = [[HadInvestController alloc]init];
        ...
        animation.subtype = kCATransitionFromRight;
        [self.view.window.layer addAnimation:animation forKey:nil];
        [self presentViewController:hasUsed animated:NO completion:nil];
...
- (void)backBtnAction:(UIButton*)sender
{
      ...
      // ChanpinViewController *redPackageVC =[[ChanpinViewController alloc]init];
...
//    
//            if ([tem isKindOfClass:[ChanpinViewController class]]) {
//    
//    
