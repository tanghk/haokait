...
@interface RedEnvelopesController (){
...
@implementation RedEnvelopesController
...
- (void)viewDidLoad {
  ...
  [self requestExprienceData];
    ...
    __weak RedEnvelopesController* weakSelf = self;
    //下拉刷新的头视图
...
- (void)exchangekBtnAction:(UIButton *)sender{
    ...
    ExchangeConponController *exchangeConponVC = [[ExchangeConponController alloc]init];
...
//    
    ...
    [self presentViewController:exchangeConponVC animated:NO completion:nil];
