...
- (void)awakeFromNib
{
    ...
    [self.sureBtn setTitleColor:[UIColor colorwithHexString:@"000000"] forState:0];
    self.sureBtn.layer.borderColor = [[UIColor colorwithHexString:@"000000"] CGColor];
    ...
    [self.sureBtn setTitleColor:[UIColor colorwithHexString:@"000000"] forState:0];
    self.cannelBtn.layer.borderColor = [[UIColor colorwithHexString:@"000000"] CGColor];
...
- (NSString *)timeFormat1
{

    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
    [dateFormatter setDateFormat:@""];
    NSString *currentOlderOneDateStr1 =@"请输入日期";
    return currentOlderOneDateStr1;
}
...
- (IBAction)removeBtnClick:(id)sender {
    ...
    self.selectDate = [self timeFormat1];
