...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    static NSString *indentifier = @"Experience_Coupon_Cell";
    ExperienceCouponCell *cell = [tableView dequeueReusableCellWithIdentifier:indentifier];
      if (cell==nil) {
    
    cell = [[ExperienceCouponCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:indentifier];
...
ExprienceModel *model =self.data[indexPath.row];
//    
    cell.model =model;
