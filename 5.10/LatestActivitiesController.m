...
#import "UICommons.h"
#import "Masonry.h"
@interface LatestActivitiesController (){
...
@implementation LatestActivitiesController
...
- (void)creatWithNavGation{
    ...
    _titleLabel.frame = CGRectMake(52, 68/2, __kScreenWidth__-104, 32/2);
...
- (void)requestWebViewURL{
    ...
    NSString *urlStr =_urlStr;// @"http://debug.otouzi.com:8012/SiteNotice/riskReserveFund.html";
