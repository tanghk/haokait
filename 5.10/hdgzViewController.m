...
#import "UICommons.h"
#import "Masonry.h"
@interface hdgzViewController ()<NJKWebViewProgressDelegate,UIWebViewDelegate>
...
@implementation hdgzViewController
    ...
    [manager GET:@"http://debug.otouzi.com:8012/user/center"
      parameters:@{}
         success:^(AFHTTPRequestOperation *  operation, id   responseObject) {
             ...
             dic = responseObject;
             [[NSUserDefaults standardUserDefaults] setObject:dic[@"data"][@"login_chinapnr_url"][@"href"] forKey:@"wangzhi"];
             
             _WANGZHI = [[NSUserDefaults standardUserDefaults]objectForKey:@"wangzhi"];
             
             NSLog(@"%@",_WANGZHI);
             
             UIWebView *_webView = [[UIWebView alloc] initWithFrame:CGRectMake(0,64.5,self.view.bounds.size.width,__kScreenHeight__-64.5)];
