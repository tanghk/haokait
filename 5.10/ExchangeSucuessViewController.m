//
//  ExchangeSucuessViewController.m
//  555
//
...
#import "UIViewExt.h"
@interface ExchangeSucuessViewController (){
...
@implementation ExchangeSucuessViewController
...
- (void)checkAction{
        ...
        for (UIViewController * tem in self.navigationController.viewControllers) {
            ...
            if ([tem isKindOfClass:[RedConponViewController class]]) {
