...
#import "UICommons.h"
#import "Masonry.h"
@interface ggxqViewController ()<NJKWebViewProgressDelegate>
{
...
- (void)viewDidLoad {
    ...
    NSString *weburl = [[NSUserDefaults standardUserDefaults]objectForKey:@"ggxqurl"];
