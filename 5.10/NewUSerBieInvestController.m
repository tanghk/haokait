...
@interface NewUSerBieInvestController ()

@end

@implementation NewUSerBieInvestController
...
//              
                    ...
                    [self.navigationController pushViewController:hasInvest animated:YES];
                    

                    
                }else if ([target isEqualToString:@"ProductList"]){
...
- (void)backBtnAction:(UIButton*)sender
{
   ...
   // NewUerBieController *new = [[NewUerBieController alloc]init];
