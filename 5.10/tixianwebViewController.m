...
@interface tixianwebViewController ()<NJKWebViewProgressDelegate>
{
...
- (void)viewDidLoad {
    ...
    huifuweb = [[UIWebView alloc]initWithFrame:CGRectMake(0, 64.5, __kScreenWidth__, __kScreenHeight__-64.5)];
    
    
    NSURL *url = [NSURL URLWithString:_withdraw];
