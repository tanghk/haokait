...
@interface IncreaseCouponCell : UITableViewCell{
        ...
        UILabel *_increaseLabel;               //利息
        UILabel *_descriotionDetail;
    
        
   
}
@property (nonatomic ,strong)IncreaseCouponModel *model;
@end
