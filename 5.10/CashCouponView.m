...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    static NSString *indentifier = @"Cash_Coupon_Cell";
    CashCouponCell *cell = [tableView dequeueReusableCellWithIdentifier:indentifier];
    if (cell==nil) {
        
        cell = [[CashCouponCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:indentifier];
    ...
    CashCouponModel *model =self.data[indexPath.row];
    //
    cell.model =model;
